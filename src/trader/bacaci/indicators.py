...
def HeikinAshi(df):
    ...
    for i in range(df_ha.shape[0]):
        ...
        df_ha.loc[df_ha.index[i],'high'] = max(df['high'][i], df_ha.loc[df_ha.index[i],'close'], df_ha.loc[df_ha.index[i],'open'])
        df_ha.loc[df_ha.index[i],'low'] = min(df['low'][i], df_ha.loc[df_ha.index[i],'close'], df_ha.loc[df_ha.index[i],'open'])
    df_ha = df_ha.iloc[1:,:]
    return df_ha
